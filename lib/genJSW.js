...
(function() {
  var BinaryPrecedence, CodeGenerator, E_FFT, E_FTT, E_TFF, E_TFT, E_TTF, E_TTT, FORMAT_DEFAULTS, FORMAT_MINIFY, F_ALLOW_CALL, F_ALLOW_IN, F_ALLOW_UNPARATH_NEW, F_DIRECTIVE_CTX, F_FUNC_BODY, F_SEMICOLON_OPT, Precedence, S_FFFF, S_TFFF, S_TFFT, S_TFTF, S_TTFF, SourceNode, Syntax, addComments, addIndent, adjustMultilineComment, base, calculateSpaces, directive, endsWithLineTerminator, escapeAllowedCharacter, escapeDirective, escapeDisallowedCharacter, escapeRegExpCharacter, escapeString, escapeless, estraverse, esutils, extra, flattenToString, generate, generateAsyncPrefix, generateBlankLines, generateComment, generateIdentifier, generateInternal, generateMethodPrefix, generateNumber, generateRegExp, generateStarSuffix, generateVerbatim, generateVerbatimString, getDefaultOptions, hasLineTerminator, hexadecimal, indent, isArray, isExpression, isStatement, join, json, log, merge, newline, noEmptySpace, parentheses, parenthesize, parse, preserveBlankLines, quotes, renumber, safeConcatenation, semicolons, sourceCode, sourceMap, space, stringRepeat, toSourceNodeWhenNeeded, updateDeeply, withIndent;
  ...
  generateNumber = cT("nerateNumber=value->~184fcT")(function(value) {
  ...
  toSourceNodeWhenNeeded = cT("ded=generated,node->~354fcT")(function(generated, node) {
    if (!sourceMap) {
  ...
  generateIdentifier = cT("ateIdentifier=node->~579fcT")(function(node) {
  ...
  generateInternal = cT("erateInternal=node->~593fcT")(function(node) {
    var codegen;
    codegen = void 0;
  ...
  generate = cT("erate=node,options->~601fcT")(function(node, options) {
  ...
  CodeGenerator.prototype.maybeBlock = cT("beBlock=stmt,flags->~656fcT")(function(stmt, flags) {
  ...
  CodeGenerator.prototype.maybeBlockSuffix = cT("Suffix=stmt,result->~670fcT")(function(stmt, result) {
    var ends;
  ...
  CodeGenerator.prototype.generatePattern = cT("e,precedence,flags->~676fcT")(function(node, precedence, flags) {
  ...
  CodeGenerator.prototype.generateFunctionParams = cT("unctionParams=node->~680fcT")(function(node) {
  ...
  CodeGenerator.prototype.generateFunctionBody = cT("eFunctionBody=node->~709fcT")(function(node) {
    var expr, result;
    result = void 0;
    expr = void 0;
  ...
  CodeGenerator.prototype.generateAssignment = cT("r,precedence,flags->~748fcT")(function(left, right, operator, precedence, flags) {
  ...
  CodeGenerator.Statement = {
    BlockStatement: cT("atement:stmt,flags->~757fcT")(function(stmt, flags) {
    ...
    EmptyStatement: cT("atement:stmt,flags->~868fcT")(function(stmt, flags) {
      return ";";
    }),
    ...
    ExpressionStatement: cT("atement:stmt,flags->~919fcT")(function(stmt, flags) {
    ...
    VariableDeclarator: cT("larator:stmt,flags->~997fcT")(function(stmt, flags) {
      var itemFlags;
    ...
    VariableDeclaration: cT("aration:stmt,flags->~1002fcT")(function(stmt, flags) {
    ...
    IfStatement: cT("atement:stmt,flags->~1133fcT")(function(stmt, flags) {
    ...
    ForStatement: cT("atement:stmt,flags->~1155fcT")(function(stmt, flags) {
      var result, that;
      result = void 0;
      that = this;
      withIndent(function() {
    ...
    Program: cT("Program:stmt,flags->~1198fcT")(function(stmt, flags) {
    ...
    FunctionDeclaration: cT("aration:stmt,flags->~1224fcT")(function(stmt, flags) {
  ...
  CodeGenerator.Expression = {
    SequenceExpression: cT("r,precedence,flags->~1251fcT")(function(expr, precedence, flags) {
      var i, iz, result;
      result = void 0;
      i = void 0;
      iz = void 0;
    ...
    ThisExpression: cT("r,precedence,flags->~1545fcT")(function(expr, precedence, flags) {
      return "this";
    }),
    Super: function(expr, precedence, flags) {
      return "super";
    },
    Identifier: cT("r,precedence,flags->~1551fcT")(function(expr, precedence, flags) {
    ...
    Literal: cT("r,precedence,flags->~1573fcT")(function(expr, precedence, flags) {
      var raw;
      raw = void 0;
  ...
  CodeGenerator.prototype.generateExpression = cT("r,precedence,flags->~1664fcT")(function(expr, precedence, flags) {
    var result, type;
    result = void 0;
    type = void 0;
  ...
  CodeGenerator.prototype.generateStatement = cT("atement=stmt,flags->~1673fcT")(function(stmt, flags) {
    var fragment, result;
    result = void 0;
    fragment = void 0;
